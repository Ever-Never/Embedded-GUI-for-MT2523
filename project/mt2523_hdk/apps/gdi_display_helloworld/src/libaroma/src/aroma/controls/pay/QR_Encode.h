...
#define MAX_MODULESIZE		40	// 21:Version=1,最大字符=17(8.5个汉字)
...
typedef struct 
{
	unsigned int ncRSBlock;		//纠错的块数
	unsigned int ncAllCodeWord;	//码字总数
	unsigned int ncDataCodeWord;	//指定纠错等级下的数据码字数
}RS_BLOCKINFO;
typedef struct 
{
