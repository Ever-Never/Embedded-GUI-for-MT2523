 ...
 */
extern  LIBAROMA_MUTEX _libaroma_wm_log_mutex; 

byte libaroma_start() {
  libaroma_mutex_init(_libaroma_wm_log_mutex);
  ...
  if (!libaroma_fb_init()) {
    ...
    return 0;
	  ...
	  ALOGI("libaroma_start start framebuffer end ... ");
  }
  ...
  if (!libaroma_font_init()) {
    ...
    return 0;
	  ...
	  ALOGI("libaroma_start  start font engine end ... ");
  }
  ...
  if (!libaroma_hid_init()) {
    ...
    return 0;
	  ...
	  ALOGI("libaroma_start  start hid engine end ...");
  }
  ...
  if (!libaroma_lang_init()) {
    ...
    return 0;
	  ...
	  ALOGD("libaroma_start  start language engine end ...");
  }
  ...
  if (!libaroma_timer_init()) {
    ...
    return 0;
	  ...
	  ALOGD("libaroma_start  start timer engine end ...");
  }
  ...
  if (!libaroma_wm_init()){
    ...
    return 0;
	  ...
	  ALOGD("libaroma_start  start window manager end ...");
  }
