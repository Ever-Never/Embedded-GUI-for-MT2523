 ...
 */
LIBAROMA_ZIP libaroma_zip(const char * filename) {
 ...
 */
void libaroma_zip_release(LIBAROMA_ZIP zip) {
 ...
 */
byte libaroma_zip_extract(LIBAROMA_ZIP zip, const char * zpath,
		const char * dest) {
 ...
 */
int libaroma_zip_read(LIBAROMA_ZIP zip, bytep * bufp, const char * zpath,
		byte bytesafe) {
